  ...
  selectHourlyConditions(){
    return this.props.navState.hourlyConditions.map(function(object, index){
              if (object.icon === 'cloudy'){
                ...
                return <td key={index} className="weatherSummary"  id='rain'><i className="wi wi-day-rain"></i></td>
              } else if (object.icon === 'clear' || object.icon === 'clear-night' || object.icon === 'clear-day'){
                return <td key={index} className="weatherSummary"  id='sun'><i className="wi wi-day-sunny"></i></td>
              } else if (object.icon === 'snow'){
                return <td key={index} className="weatherSummary"  id='snow'><i className="wi wi-day-snow"></i></td>
              } else if (object.icon === 'scattered-showers'){
                return <td key={index} className="weatherSummary"  id='scatteredShowers'><i className="wi wi-day-showers"></i></td>
              } else if (object.icon === 'thunder'){
                return <td key={index} className="weatherSummary"  id='thunder'><i className="wi wi-day-thunderstorm"></i></td>
